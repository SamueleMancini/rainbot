...
def download_dataset(download_segmented=False):
    # Define the folders we want to download
    if download_segmented:
        folders_to_download = ["truly_final_datasets", "road", "vegetation", "terrain"]
    else:
        folders_to_download = ["truly_final_datasets"]
...
download_dataset(download_segmented=True)