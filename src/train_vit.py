...
training_args = TrainingArguments(
    output_dir=str(project_root / "models" / f"swin_b_finetuned"),
    ...
    learning_rate=5e-5,
    logging_dir=str(project_root / "logs" / f"swin_b_all"),
...
trainer.model.save_pretrained(str(project_root / "models" / f"swin_b_finetuned"))
